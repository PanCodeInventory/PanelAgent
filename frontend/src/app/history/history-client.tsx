...
import type { SelectedAntibody } from "@/lib/api/panel-history";
...
export default function HistoryClientPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8" data-testid="history-page">
      <div className="mb-6">
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {state.entries.map((entry, idx) => (
                    ...
                    >
                      <td className="px-4 py-3 text-foreground" data-testid="history-detail-trigger">
